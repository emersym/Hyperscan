...
// STARTPOINT RANGE LEVELS
var colors = {
  h: 200,
  s: 80,
  l: 50,
  
  // TEXT COLOR CHANGE BASED ON BRIGHTNESS
  textColor: function() {
    return this.l > 42 ?
      "black" :
      "white";
...
// DETERMINES HUE VALUE
  hueValue: function() {
    return Math.floor(this.h);
  },
// DETERMINES SATURATION VALUE
  satValue: function() {
    return Math.floor(this.s) + "%";
  },
// DETERMINES LIGHTNESS VALUE 
  lumValue: function() {
...
// CONTROLS TEXT DESCRIBING HSL/RGB LEVELS
